...
function buildPdfDocDefinition(factura, empresa, cliente, type, itemsTable, totalTextLines, documentTitle) {
...
const startMarker = 'async function fetchImageAsBase64(url) {';
...
if (startIndex !== -1 && endIndex !== -1) {
    ...
    content = content.replace(originalSection, newPdfLogic + '\\n\\n');
