  ...
  try {
    ...
    await prisma.empresa.update({
      ...
      data: {
        ...
        numeroRepse: data.numeroRepse || null,
        ...
        redSocialInstagram: data.redSocialInstagram || null,
        redSocialLinkedin: data.redSocialLinkedin || null,
        redSocialX: data.redSocialX || null,
