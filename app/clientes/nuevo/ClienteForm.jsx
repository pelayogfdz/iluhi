...
export default function ClienteForm({ createClienteAction }) {
  ...
  return (
    <>
      ...
      <form action={createClienteAction} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>

        <div className="form-group">
          <label htmlFor="rfc">RFC del Cliente</label>
          <input type="text" id="rfc" name="rfc" className="form-control" required placeholder="Ej. XAXX010101000" defaultValue={csfData.rfc} key={`rfc-${csfData.rfc}`} />
        ...
        <div className="form-group">
          ...
          <input type="text" id="razonSocial" name="razonSocial" className="form-control" required placeholder="Ej. PUBLICO EN GENERAL" defaultValue={csfData.razonSocial} key={`rs-${csfData.razonSocial}`} />
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
            <div className="form-group">
              ...
              <SearchableSelect 
                ...
                required={true}
                value={csfData.regimen}
                key={`reg-${csfData.regimen}`}
              />
            </div>

            <div className="form-group">
              <label htmlFor="codigoPostal">Domicilio Fiscal (C.P.)</label>
              <input type="text" id="codigoPostal" name="codigoPostal" className="form-control" required placeholder="Ej. 11000" defaultValue={csfData.codigoPostal} key={`cp-${csfData.codigoPostal}`} />
            </div>
        </div>
